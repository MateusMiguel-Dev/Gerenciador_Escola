...
public class FormCadAluno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbSistema.setText("Cadastro de Aluno");
    ...
    //----- ARÉA DE CONFERIR OS DADOS DA INSERÇÃO DE NOVO [ALUNO] NO BANCO DE DADOS -----    
    private void btnCadastroSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastroSubmitActionPerformed
        if(txtRA.getText().equals("") || txtIRA.getText().equals("") || txtNome.getText().equals("") || ftxtCPF.getText().equals("") || ftxtDataNasc.getText().equals("") || ftxtTelefone.getText().equals("")){
            ...
            Aluno aluno = new Aluno(txtRA.getText(), Float.parseFloat(txtIRA.getText()), txtNome.getText(), cpf_final, ftxtDataNasc.getText(), ftxtTelefone.getText());   
