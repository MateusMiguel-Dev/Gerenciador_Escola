 ...
 * @author Tomat
 */
public class FormCadTecAdmin extends javax.swing.JFrame {

    /**
     * Creates new form login
     */
    public FormCadTecAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lbSistema.setText("Cadastro de Técnico Admnistrativo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCadTecAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCadTecAdmin().setVisible(true);
            }
        });
    }
